...
@Component({
  selector: 'app-bot-trade-list',
  templateUrl: './bot-trade-list.component.html',
  styleUrls: ['./bot-trade-list.component.scss']
})
export class BotTradeListComponent implements OnInit, AfterViewInit {
  ...
  fetchTrades(): void {
    if (this.market) {
      this.tradeService.getBotTrades(this.market).subscribe(
        (response) => {
